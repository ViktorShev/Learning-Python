...
"""
from personas.views import detallePersona, nuevaPersona, editarPersona, eliminarPersona, detalleDomicilio, nuevoDomicilio, editarDomicilio, eliminarDomicilio
